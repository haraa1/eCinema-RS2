...
namespace eCinema.Models
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Booking>(entity =>
            {
                ...
                entity.HasOne(b => b.AppliedDiscount)
                    .WithMany()
                    .HasForeignKey(b => b.AppliedDiscountId)
                    .OnDelete(DeleteBehavior.Restrict);
    ...
    new TicketType { Id = 1, Name = "Adult", PriceModifier = 1.00m },
    new TicketType { Id = 2, Name = "Child", PriceModifier = 0.75m },
    new TicketType { Id = 3, Name = "Senior", PriceModifier = 0.80m }
);
            ...
            modelBuilder.Entity<Discount>(entity =>
            {
                ...
                entity.Property(d => d.DiscountPercentage).HasColumnType("decimal(5, 2)");
            });
